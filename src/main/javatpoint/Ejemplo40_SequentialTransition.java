...
public class Ejemplo40_SequentialTransition extends Application
{
  ...
  public void start(Stage primaryStage) throws Exception
  {
    ...
    //Instantiating Sequential Transition class by passing the 
    // list of transitions into its constructor  
    SequentialTransition seqT = new SequentialTransition(poly, rotate, pause, 
