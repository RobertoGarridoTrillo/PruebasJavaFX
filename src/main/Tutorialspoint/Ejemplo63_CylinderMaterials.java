...
public class Ejemplo63_CylinderMaterials extends Application
{
  ...
  public void start(Stage stage)
  {
    ...
    material1.setBumpMap(
            new Image("http://www.tutorialspoint.com/images/tp-logo.gif"));
    ...
    material2.setDiffuseMap(new Image("main/images/tp-logo.gif"));
    ...
    material3.setSelfIlluminationMap(new Image("main/images/tp-logo.gif"));
    ...
    material4.setSpecularMap(new Image("main/images/tp-logo.gif"));
