 ...
 * reflection effect.
 *
 * topOffset − This property is of double type representing the distance between
 * the bottom of the input and the top of the reflection.
 *
 * fraction −This property is of double type representing the fraction of input
 * that is visible in the output. The range of the fraction value is 0.0 to 1.0.
 *
...
public class Ejemplo41_Reflection extends Application
{
