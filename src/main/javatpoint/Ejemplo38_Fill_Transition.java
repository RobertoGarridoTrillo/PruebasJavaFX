 ...
 * @author ROBEG
 */
public class Ejemplo38_Fill_Transition extends Application
{
  ...
  public void start(Stage primaryStage) throws Exception
  {
    ...
    poly.getPoints().addAll(new Double[]{220.0, 270.0, 170.0, 220.0, 
      170.0, 120.0, 220.0, 70.0, 270.0, 120.0, 270.0, 220.0});
