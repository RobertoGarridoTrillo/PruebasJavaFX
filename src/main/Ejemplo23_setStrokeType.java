 ...
 */
public class Ejemplo23_setStrokeType extends Application
{
  ...
  {
    circleses[1].setStroke(Color.RED);
    circleses[1].setStrokeWidth(16);
    circleses[1].setStrokeType(StrokeType.INSIDE);

    circleses[2].setStroke(Color.RED);
    circleses[2].setStrokeWidth(16);
    circleses[2].setStrokeType(StrokeType.CENTERED);

    circleses[3].setStroke(Color.RED);
    circleses[3].setStrokeWidth(16);
